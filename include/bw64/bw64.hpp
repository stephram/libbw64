...
namespace bw64 {
     ...
     *
     * Convenience function to open a new BW64 file for writing, adding `axml`
     * and `chna` chunks.
     *
     ...
     *
     */
    inline std::unique_ptr<Bw64Writer> writeFile(const std::string& filename,
        ...
        return std::unique_ptr<Bw64Writer>(
            new Bw64Writer(filename.c_str(), channels, sampleRate, bitDepth, additionalChunks));
    }
